...
import com.hotel.cloud.common.validator.group.AliyunGroup;
import com.hotel.cloud.common.validator.group.QcloudGroup;
import com.hotel.cloud.common.validator.group.QiniuGroup;
import com.hotel.cloud.modules.oss.cloud.CloudStorageConfig;
...
public class SysOssController {
	...
	public R upload(@RequestParam("file") MultipartFile file) throws Exception {
		...
		return R.ok().put("url", sysOssService.saveFile(file).getUrl());
	}
